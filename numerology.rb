...
def get_message(birth_path_num)
  ...
  when 7
    puts "Your numerology number is #{birth_path_num}. \nhis is the deep thinker. The number seven is a spiritual vibration. These people are not very attached to material things, are introspective, and generally quiet. Ruled by Neptune."
  when 8
...
puts "What's your birthdate in MMDDYYYY?"
birthdate = gets
